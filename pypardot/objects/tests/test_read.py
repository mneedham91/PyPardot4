...
API_READ_TEST_IDS = {
	...
	'emailTemplate': None,
	'form': 555,
	'lifecycleHistory': None,
	'lifecycleStage': None,
	'list': 611,
	'listMembership': None,
	'opportunity': 81221,
	'prospect': 13748447,
	'prospectAccount': 343305,
	'tag': None,
	'tagObject': None,
	'user': 18469413,
	'visitor': None,
	'visitorActivity': None,
	'visit': None
}
...
class TestGenericApiOperations(unittest.TestCase):
	...
	def test_read(self):
		...
		for obj_name in sorted(API_SUPPORTED_OPERATIONS.iterkeys()):
			ops = API_SUPPORTED_OPERATIONS[obj_name]
			if method in set(ops) and obj_name in API_READ_TEST_IDS and API_READ_TEST_IDS[obj_name] is not None:
				print "[{}.{}]...".format(obj_name, method)
				obj = getattr(self.pardot, pluralize(obj_name).lower())
				try:
					results = getattr(obj, method)(id=API_READ_TEST_IDS[obj_name])
